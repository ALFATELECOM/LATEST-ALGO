...
function StrategyManager() {
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Strategy Manager</h3>
      <div className="space-y-4">
        <div className="border rounded-lg p-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button className="bg-green-600 text-white px-3 py-1 rounded text-sm">Active</button>
            </div>
          </div>
        </div>
        <div className="border rounded-lg p-4">
          <div className="flex justify-between items-center">
            <div>
              <h4 className="font-medium">MACD Strategy</h4>
              <p className="text-sm text-gray-600">Moving average convergence divergence</p>
            </div>
            <div className="flex items-center space-x-2">
              <span className="text-green-600 font-medium">+₹800</span>
              <button className="bg-green-600 text-white px-3 py-1 rounded text-sm">Active</button>
            </div>
          </div>
        </div>
...
function OrderBook() {
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Order Book</h3>
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">RELIANCE</td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600">COMPLETE</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">TCS</td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm">₹3,500</td>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          <h4 className="text-lg font-medium text-gray-900 mb-2">Win Rate</h4>
          <p className="text-3xl font-bold text-green-600">65%</p>
        </div>
        <div className="bg-white shadow rounded-lg p-6">
          <h4 className="text-lg font-medium text-gray-900 mb-2">Sharpe Ratio</h4>
          <p className="text-3xl font-bold text-blue-600">1.2</p>
        </div>
        <div className="bg-white shadow rounded-lg p-6">
          <h4 className="text-lg font-medium text-gray-900 mb-2">Max Drawdown</h4>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          <h4 className="text-lg font-medium text-gray-900 mb-4">Portfolio Risk</h4>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <h4 className="text-lg font-medium text-gray-900 mb-4">Risk Limits</h4>
          <div className="space-y-2">
            <div className="flex justify-between">
